...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    const verifyToken = async () => {
      ...
      // Note: Server restart check removed - refactored backend doesn't have server-info endpoint
      ...
      try {
        ...
        console.error(
          "AuthContext: Error during token verification, clearing auth data"
        );
        localStorage.removeItem("access_token");
        localStorage.removeItem("refresh_token");
        localStorage.removeItem("cached_username");
  ...
  const login = async (username, password) => {
    try {
      ...
      // Note: Server restart detection removed - refactored backend doesn't have server-info endpoint
