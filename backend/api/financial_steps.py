...
class FinancialStepsView(APIView):
    ...
    def calculate_financial_steps(self, accounts, debts, budget, user_id):
        ...
        step2_completed = step2_meets_condition and step1_progress['completed']
        if step2_completed:
            step2_progress = {
                'completed': True,
                'progress': 100,
            ...
            step2_progress = {
                'completed': False,
                'progress': 0,
                'message': f'${total_debt:,.2f} in non-mortgage debt remaining' if step1_progress['completed'] else 'Step 1 must be completed first',
